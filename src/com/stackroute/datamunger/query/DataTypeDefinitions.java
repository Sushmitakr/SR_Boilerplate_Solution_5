...
public class DataTypeDefinitions {
	...
	public static Object getDataType(String input) {
        ...
        // checking for floating point numbers
        else if(input.matches("^(-?)(0|([1-9][0-9]*))(\\.[0-9]+)?$")) {
    ...
    private static Object integerValue(String input) {
        // TODO Auto-generated method stub
        Integer num = Integer.parseInt(input);
        return num;
    }

    private static Object doubleValue(String input) {
        // TODO Auto-generated method stub
        Double dbl = Double.parseDouble(input);
        return dbl;
    }
    
    public static Date getDateValue(String input, String format) {
